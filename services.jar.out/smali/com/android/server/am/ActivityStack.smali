...
.method final resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    ...
    .line 1535
    .end local v17           #last:Lcom/android/server/am/ActivityRecord;
    :catch_4
    move-exception v2
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/os/IBinder;Ljava/lang/String;IIIILandroid/os/Bundle;Z[Lcom/android/server/am/ActivityRecord;)I
    ...
    .line 2481
    .local v27, exception:Ljava/lang/String;
    move-object/from16 v0, v20
    ...
    .line 2486
    .end local v27           #exception:Ljava/lang/String;
    :cond_2
    if-eqz v30, :cond_8
    ...
    .end local v28           #i$:I
    .end local v30           #isActivityAllowed:Z
    .end local v34           #len$:I
    ...
    .end local v37           #oldPolicy:Landroid/os/StrictMode$ThreadPolicy;
    :cond_6
    const-string v3, "ActivityManager"
    ...
    .restart local v27       #exception:Ljava/lang/String;
    .restart local v28       #i$:I
    .restart local v30       #isActivityAllowed:Z
    .restart local v34       #len$:I
    .restart local v37       #oldPolicy:Landroid/os/StrictMode$ThreadPolicy;
    ...
    .line 2503
    .local v32, km:Landroid/app/enterprise/kioskmode/IKioskMode;
    if-eqz v32, :cond_3
    ...
    .line 2507
    .end local v32           #km:Landroid/app/enterprise/kioskmode/IKioskMode;
    :catch_1
    move-exception v25
    ...
    .line 2518
    .local v44, topActivity:Ljava/lang/String;
    const/16 v30, 0x0
    ...
    .line 2520
    .local v31, isTopActivityException:Z
    invoke-virtual/range {v23 .. v23}, Landroid/content/ComponentName;->getClassName()Ljava/lang/String;
    ...
    .line 2651
    .local v46, watchIntent:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .line 2657
    .end local v46           #watchIntent:Landroid/content/Intent;
    :goto_9
    if-eqz v19, :cond_1b
    ...
    .line 2651
    .restart local v46       #watchIntent:Landroid/content/Intent;
    :cond_1a
    const/16 v19, 0x0
